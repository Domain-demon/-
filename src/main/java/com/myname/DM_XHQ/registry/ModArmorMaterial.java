...
public class ModArmorMaterial {
    ...
    public static ForgeArmorMaterials LEGEND = new ForgeArmorMaterials ("legend",40, new int[]{4, 7, 9, 4}, 15,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.2F,() -> Ingredient.of(ModItem.TEXT_INGOT.get())) ;


    //在这里添加我们的盔甲基础属性	new int[] 四个位置分别为头、护腿、胸甲、鞋子
    ...
    public String getName() {
        return TrierMod.MODID + ":" + this.name;
    }
