...
public class BeeSoldier extends Monster implements IAnimatable, FlyingAnimal {
    ...
    public BeeSoldier(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event){
        if(event.isMoving()){
            event.getController().setAnimation( new AnimationBuilder().addAnimation("animation.pathfinding", ILoopType.EDefaultLoopTypes.HOLD_ON_LAST_FRAME));
            // 继续播放
            return PlayState.CONTINUE;
        }
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.fling", ILoopType.EDefaultLoopTypes.LOOP));
        return PlayState.CONTINUE;
    ...
    private PlayState attackPredicate(AnimationEvent event) {
        if(this.swinging && event.getController().getAnimationState().equals(AnimationState.Stopped)) {
            ...
            event.getController().setAnimation( new AnimationBuilder().addAnimation( "animation.attack", ILoopType.EDefaultLoopTypes.PLAY_ONCE));
            this.swinging = false;
        }
        return PlayState.CONTINUE;
    }
